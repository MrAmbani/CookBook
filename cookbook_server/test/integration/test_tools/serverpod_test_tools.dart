...
import 'package:cookbook_server/src/generated/protocol.dart';
import 'package:cookbook_server/src/generated/endpoints.dart';
...
class _GreetingEndpoint {
  ...
  _ida.Future<_ist8xn37.Greeting> hello(
    _ist.TestSessionBuilder sessionBuilder,
    String name,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
