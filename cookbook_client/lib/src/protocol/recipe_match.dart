...
import 'package:cookbook_client/src/protocol/protocol.dart' as _i4jo8f4z;
...
abstract class RecipeMatch
  ...
  factory RecipeMatch.fromJson(Map<String, dynamic> jsonSerialization) {
    return RecipeMatch(
      recipe: _i4jo8f4z.Protocol().deserialize<_ixmlxsuh.Recipe>(
        jsonSerialization['recipe'],
      ),
      score: (jsonSerialization['score'] as num).toDouble(),
      missingIngredients: _i4jo8f4z.Protocol().deserialize<List<String>>(
